...
export default function Pclient() {
    return (
        <div className="mt-5 container text-center">
            <p className="text-muted fw-bold">POPULAR CLIENTS</p>
            <p className="fw-bold" style={{ fontSize: '2rem', lineHeight: '1.2' }}>
                Trusted by over 10,000+ <br /> clients
            </p>

            <div className="d-flex flex-wrap justify-content-center align-items-center gap-3 mt-4" style={{ filter: "grayscale(100%)" }}>
                <img
